...
if($msg){
	echo "<script>alert('".$msg."');window.location.href='yunku_category_soft.php?model=".$topic."'</script>";
	exit;
}
//add
?>
...
<?php
$sql="SELECT id,name FROM am_category where parent_id=5";
$query = mysql_query($sql,$conn);
