...
if(!empty($_SESSION['uid'])&&!empty($_SESSION['username'])){
	...
	$conn = connect_db();
	$get_path=$_SERVER['AM_SITE_ROOT'].'data/yunlib_rank_soft.txt';
...
if($msg) echo "<script>alert('".$msg."');window.location.href='./yunku_rank_soft_month.php'</script>";
//add
?>
