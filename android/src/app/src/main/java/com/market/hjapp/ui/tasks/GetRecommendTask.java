...
public class GetRecommendTask extends BaseAsyncTask {

	private boolean mIsRunning = false;

    public GetRecommendTask(Activity a, TaskResultListener l) {
        super(a, l, false);
    }
    ...
    protected HashMap<String, Object> doInBackground(String... params) {
        ...
        try {
            return NetworkManager.getRecommmendByTime(
                    mActivity, 
                    params[0]); // recommend time   
