...
public class GetNewestCateDataTask extends BaseAsyncTask {

	private boolean mIsRunning = false;

    public GetNewestCateDataTask(Activity a, TaskResultListener l) {
        super(a, l, false);
    }
    ...
    protected HashMap<String, Object> doInBackground(String... params) {
        ...
        try {
            return NetworkManager.getNewestCateData(
                    mActivity, 
                    params[0]);    // appid
