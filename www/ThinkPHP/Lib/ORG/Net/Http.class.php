...
{//类定义开始
    ...
    */
     ...
     * @throws ThinkExecption
     +----------------------------------------------------------
     */
    static public function download ($filename, $showname='',$content='',$expire=0) {
        if(is_file($filename)) {
        ...
        $showname = mb_strrpos($showname,'/')?mb_substr($showname,mb_strrpos($showname,'/')+1):$showname;//basename($showname);
