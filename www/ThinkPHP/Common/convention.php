...
return  array(
	...
	'TMPL_JUMP_LAYOUT'		=> false,		// 成功，错误跳转页面是否加载布局
	'TMPL_LAYOUT_TPL'		=> 'Layout:layout', // 默认成功,错误加载的布局文件
	'TMPL_LAYOUT_LABEL'		=> 'viewcontent', // 默认成功,错误加载的布局文件
