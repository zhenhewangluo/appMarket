...
document.myform.action='<?php echo U("Developer/appAuditAction");?>';
document.myform.submit();
}
function auditfailfc(){
document.myform.action='<?php echo U("Developer/appAuditfailAction");?>';
document.myform.submit();
}		
</script>
		...
		<form name="myform" id="myform"  method="post">
			...
			<table class="form_table">
				...
				<tr>
					<th></th>
					<td>
						<input type="button" id="submit_app" onclick="auditsuccess();" value="通过" />
                        <input type="button" id="auditfail" onclick="auditfailfc();" value="不通过" />
