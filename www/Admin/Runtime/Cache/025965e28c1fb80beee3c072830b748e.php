...
<div class="headbar clearfix">
	<div class="position"><span>应用</span><span>></span><span>应用管理</span><span>></span><span>添加应用</span></div>
...
<div class="content_box">
	<div class="content form_content">
		<form action="<?php echo U('AppStore://Apps/appDeviceAdd');?>" method="post">
			...
			<table class="form_table" id="app_info" style="display:none;">
				<col width="150px" />
				<col />
				<tr>
					<th>应用大小：</th>
		...
		function addApp()
		{
			...
			editor.sync();
			$.getJSON('<?php echo U("Admin://Ajax/addApp");?>',
			{
