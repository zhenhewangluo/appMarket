...
<!--					<form action="#" method="post">
				...
				<div class="box">
					...
					<div id="bookmarkIcons">
						<ul id="bookmarks">
							<li id="bookmark_sina">
								<a href="http://weibo.com/" title="***新浪微博" target="_blank" alt="***新浪微博"></a>
							</li>
							<li id="bookmark_tencent">
								<a href="http://t.qq.com/" title="***腾讯微博" target="_blank" alt="***腾讯微博"></a>
							</li>
							<li id="bookmark_sohu">
								<a href="http://.t.sohu.com" title="***搜狐微博" target="_blank" alt="***搜狐微博"></a>
							</li>
							<li id="bookmark_renren">
								<a href="http://page.renren.com/" title="***人人主页" target="_blank" alt="***人人主页"></a>
							</li>
							<li id="bookmark_163">
								<a href="http://t.163.com/" title="***网易微博" target="_blank" alt="***网易微博"></a>
							</li>
							<li id="bookmark_douban">
								<a href="http://site.douban.com//" title="***豆瓣小站" target="_blank" alt="***豆瓣小站"></a>
							</li>
						</ul>
					</div>
				</div>
