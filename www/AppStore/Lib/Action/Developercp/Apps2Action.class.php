...
//var_dump($apkimglist['screenshots']);
		...
		else
		{
			...
			{
				$apk_path = $v['apk_path'];
	//			foreach($screen as $ke => $va)
	//			{
	//				if(!array_key_exists($ke, $apkimglist))
	//				{
	//					if($v['apk_path'] != '' && strpos($v['apk_path'], $va) !== false)
	//					{
	//						$apkimglist[$ke]['apk_path'] = $v['apk_path'];
	//					}
	//					if($v['screenshots'] != '' && strpos($v['screenshots'], $va) !== false)
	//					{
	//						$apkimglist[$ke]['apk_screenshots'] = explode('|', $v['screenshots']);
	//					}
	//				}
	//
	//			}
